    ...
    >
      ...
      <Box
        ...
        sx={{
          ...
          inset: 0,
          background:
            "linear-gradient(to top right, rgba(6, 182, 212, 0.05), transparent, rgba(37, 99, 235, 0.05))",
          opacity: 0,
      ...
      >
        ...
        >
          <FiGlobe
            size={10}
            style={{ color: "var(--mui-palette-cyan-main)" }}
          />
  ...
  return (
    <LazyMotion features={domAnimation}>
      <DevBackground>
        <Container
          maxWidth="lg"
          sx={{ pb: 12, display: "flex", flexDirection: "column", gap: 16 }}
        >
          {/* ═══════════ HERO ENTRY WRAPPER ═══════════ */}
          <Box
            id="home"
            ...
            >
              ...
              >
                ...
                <Box
                  ...
                  sx={{
                    background:
                      "linear-gradient(to right, #06b6d4, #3b82f6, #4f46e5)",
              ...
              >
                FinTrack is the high-performance dashboard for engineers of
                their own finances. Track, analyze, and optimize your wealth
              ...
              >
                ...
                <Button
                  ...
                  sx={{
                    ...
                    borderColor: "divider",
                    bgcolor:
                      "rgba(var(--mui-palette-action-hoverChannel), 0.5)",
                    color: "text.primary",
                    fontWeight: "bold",
                    textTransform: "none",
                    fontSize: "16px",
          ...
          <Stack id="features" spacing={8}>
            <Box sx={{ textAlign: "center" }}>
              ...
              >
                Built with a focus on speed, privacy, and actionable
                intelligence.
              </Typography>
            </Box>
            ...
            <Grid container spacing={4}>
              {features.map((f, i) => (
                <Grid
                  ...
                  key={f.title.toLowerCase().replace(/\s+/g, "-")}
                >
                  <Card
                    component={m.div}
                    initial="hidden"
                  ...
                  >
                    <Box
                      ...
                      sx={{
                        ...
                        inset: 0,
                        background:
                          "linear-gradient(to bottom right, rgba(6, 182, 212, 0.03), transparent)",
                        opacity: 0,
          ...
          >
            ...
            <Box
              sx={{
                ...
                opacity: 0.15,
                backgroundImage:
                  "radial-gradient(circle at 2px 2px, var(--mui-palette-divider) 1px, transparent 0)",
            ...
            <Box
              sx={{
                ...
                inset: 0,
                background:
                  "linear-gradient(to bottom, transparent, rgba(6, 182, 212, 0.1), rgba(37, 99, 235, 0.1))",
              }}
            />
