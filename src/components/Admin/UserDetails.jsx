    ...
    <div className="p-6 min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
      {loading ? (
        <div className="flex flex-col gap-4 items-center">
          ...
          <div className="h-40 w-full max-w-2xl bg-white/10 animate-pulse rounded-2xl"></div>
        </div>
      ) : (
        <>
          {/* Profile Section */}
          <motion.div
            ...
            className="backdrop-blur-xl bg-white/10 p-6 rounded-2xl shadow-lg flex flex-col md:flex-row gap-6 items-center mb-8"
          >
            {/* Avatar */}
            {user?.profilePic ? (
              <img
              ...
              <div className="w-28 h-28 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center text-3xl shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            {[
              ...
              <motion.div
                ...
                className={`backdrop-blur-xl bg-gradient-to-r ${stat.color} p-6 rounded-2xl shadow-lg`}
              >
                <p className="text-sm text-white/80">{stat.label}</p>
                <p className="text-3xl font-bold">₹{stat.value.toFixed(2)}</p>
              </motion.div>
            ))}
          </div>
          ...
          >
            <h3 className="text-lg font-semibold mb-4">Yearly Trend (All Months)</h3>
