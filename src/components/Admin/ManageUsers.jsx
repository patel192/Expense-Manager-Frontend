      ...
      >
        ...
        <Grid container spacing={3} sx={{ position: "relative" }}>
            ...
            <TextField
              ...
              InputProps={{
                startAdornment: (
                  <IoSearch
                    size={18}
                    style={{ marginRight: 12, color: "var(--text-muted)" }}
                  />
                ),
              }}
              sx={{
          ...
          <Grid item xs={12} lg={3}>
            ...
            >
              <MenuItem value="all" sx={{ fontSize: "11px", fontWeight: 900 }}>
                GLOBAL PERSPECTIVE
              </MenuItem>
              <MenuItem
                value="Admin"
        ...
        {loading ? (
          ...
          >
            ...
            >
              <FiUsers
                size={40}
                style={{ opacity: 0.2, color: "var(--text-muted)" }}
              />
            </Avatar>
            <Box sx={{ textAlign: "center" }}>
              <Typography
          ...
          <>
            {/* DESKTOP MATRIX VIEW */}
            <Box
              sx={{ display: { xs: "none", lg: "block" }, overflowX: "auto" }}
            >
              <Table>
                <TableHead>
                  <TableRow
                        ...
                        <Stack direction="row" spacing={1}>
                          ...
                          <IconButton
                            ...
                            sx={{
                              ...
                              bgcolor: "#f43f5e",
                              color: "#fff",
                              boxShadow: "0 10px 15px -3px rgba(244,63,94,0.2)",
            ...
            <Pagination
              ...
              renderItem={(item) => (
                <PaginationItem
                  {...item}
                  page={
                    item.page ? String(item.page).padStart(2, "0") : undefined
                  }
                  sx={{
                    minWidth: 44,
                    height: 44,
