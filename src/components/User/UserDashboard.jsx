...
const MetricCard = memo(({ title, value, icon, color, bg, border, glow }) => (
  ...
  >
    ...
    <CardContent sx={{ p: 3 }}>
      ...
      <Typography variant="h5" sx={{ fontWeight: "black", mt: 0.5, color: color }}>
      ...
      >
        <Stack direction="row" spacing={2} alignItems="center">
          ...
          <Box>
            ...
            <Typography variant="caption" color="text.secondary" sx={{ fontSize: "9px", fontWeight: "bold", tracking: "0.1em", textTransform: "uppercase" }}>
        ...
        {onRefresh && (
          <IconButton
            ...
            sx={{
              ...
              "&:hover": { color: "cyan.main", bgcolor: "rgba(6, 182, 212, 0.1)" },
            }}
          >
...
const AIButton = ({ onClick, label, color, icon = <FiZap size={14} /> }) => (
  <Button
    ...
    sx={{
      ...
      textTransform: "none",
      boxShadow: 2,
      background: color === "bg-rose-500 text-white hover:bg-rose-600"
...
const ChartTooltip = ({ active, payload, label }) => {
  ...
  return (
    <Paper sx={{ p: 2, border: 1, borderColor: "divider", borderRadius: 3, boxShadow: 3 }}>
      <Typography variant="caption" color="text.secondary" sx={{ textTransform: "uppercase", tracking: "0.05em", fontWeight: "bold" }}>
        {label}
      </Typography>
    ...
    >
      ...
      >
        <Box>
          ...
          <Typography variant="body2" color="text.secondary" sx={{ fontWeight: "bold", textTransform: "uppercase", mt: 0.5, letterSpacing: "0.1em" }}>
        ...
        <Stack
          ...
          sx={{
            ...
            borderRadius: 4,
            border: 1,
            borderColor: savingsRate >= 20 ? "rgba(16, 185, 129, 0.2)" : "rgba(244, 63, 94, 0.2)",
            bgcolor: savingsRate >= 20 ? "rgba(16, 185, 129, 0.05)" : "rgba(244, 63, 94, 0.05)",
            color: savingsRate >= 20 ? "success.main" : "error.main",
          }}
        >
          <FiActivity size={14} />
          <Typography variant="caption" sx={{ fontWeight: "black", letterSpacing: "0.1em" }}>
        ...
        <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
          <Card
            sx={{
              ...
              borderRadius: 4,
              border: 1,
              borderColor: netSavings >= 0 ? "rgba(59, 130, 246, 0.2)" : "rgba(244, 63, 94, 0.2)",
              bgcolor: netSavings >= 0 ? "rgba(59, 130, 246, 0.05)" : "rgba(244, 63, 94, 0.05)",
              boxShadow: 2,
            }}
          >
            <Box
            ...
            <CardContent sx={{ p: 3 }}>
              <Stack direction="row" justifyContent="space-between" alignItems="flex-start" sx={{ mb: 2 }}>
                <Avatar
                  sx={{
                    ...
                    height: 40,
                    borderRadius: 3,
                    bgcolor: netSavings >= 0 ? "rgba(59, 130, 246, 0.1)" : "rgba(244, 63, 94, 0.1)",
                ...
                <Chip
                  ...
                  sx={{
                    ...
                    bgcolor: netSavings >= 0 ? "rgba(16, 185, 129, 0.1)" : "rgba(244, 63, 94, 0.1)",
                    border: 1,
                    borderColor: "divider",
                  }}
                />
              ...
              <Typography variant="h5" sx={{ fontWeight: "black", mt: 0.5, color: netSavings >= 0 ? "primary.main" : "error.main" }}>
      ...
      <Grid container spacing={3}>
          ...
          >
            {loadingRisk ? (
              <Box sx={{ display: "flex", justifyContent: "center", py: 4 }}>
                <LoadingSpinner color="error" label="Scanning transactions..." />
              </Box>
            ) : riskData ? (
              <Box
                sx={{
              ...
              >
                <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 2 }}>
                  <Typography variant="caption" sx={{ fontWeight: "bold", textTransform: "uppercase", color: "text.primary" }}>
                    Behavior Assessment
                  </Typography>
                  <Chip
                ...
                <Stack spacing={2}>
                  ...
                  <Box sx={{ pt: 1.5, borderTop: 1, borderColor: "divider" }}>
                    <Typography variant="body2" sx={{ fontWeight: "bold", color: riskColors[riskData.riskLevel]?.text }}>
                      ✨ {riskData.suggestion}
                    </Typography>
                  </Box>
                </Stack>
              ...
              <Stack alignItems="center" textAlign="center" spacing={2} sx={{ py: 2 }}>
                <Typography variant="body2" color="text.secondary" sx={{ maxW: "80%" }}>
                  Run the advanced risk engine to detect anomalies in your spending patterns.
                </Typography>
                <AIButton
                  onClick={fetchRisk}
                  label="Initiate Scan"
        ...
        <Grid size={{ xs: 12, md: 6 }}>
          ...
          >
            {loadingHealth ? (
              <Box sx={{ display: "flex", justifyContent: "center", py: 4 }}>
                <LoadingSpinner color="secondary" label="Calculating health score..." />
              </Box>
            ) : healthScore ? (
              ...
              <Stack alignItems="center" textAlign="center" spacing={2} sx={{ py: 2 }}>
                <Typography variant="body2" color="text.secondary" sx={{ maxW: "80%" }}>
                  Audit your wealth efficiency based on income vs outcome ratios.
                </Typography>
                <AIButton
        ...
        <Grid size={{ xs: 12, md: 6 }}>
          ...
          >
            {loadingInsights ? (
              <Box sx={{ display: "flex", justifyContent: "center", py: 4 }}>
                <LoadingSpinner color="primary" label="Extracting patterns..." />
              </Box>
            ) : expenseInsights ? (
              ...
              <Stack alignItems="center" textAlign="center" spacing={2} sx={{ py: 2 }}>
                <Typography variant="body2" color="text.secondary" sx={{ maxW: "80%" }}>
                  Uncover hidden correlations and structural flaws in your financial data.
                </Typography>
                <AIButton
        ...
        <Grid size={{ xs: 12, md: 6 }}>
          ...
          >
            {loadingForecast ? (
              ...
              <Stack alignItems="center" textAlign="center" spacing={2} sx={{ py: 2 }}>
                <Typography variant="body2" color="text.secondary" sx={{ maxW: "80%" }}>
                  Generate a 3-month trajectory forecast using machine learning models.
                </Typography>
                <AIButton
        ...
        <Grid size={{ xs: 12, md: 6 }}>
          ...
          >
            {loadingSavings ? (
              ...
              <Stack alignItems="center" textAlign="center" spacing={2} sx={{ py: 2 }}>
                <Typography variant="body2" color="text.secondary" sx={{ maxW: "80%" }}>
                  Identify specific budget optimizations to maximize your monthly net surplus.
                </Typography>
                <AIButton
        ...
        <Grid size={{ xs: 12, md: 6 }}>
          ...
          >
            <Box sx={{ height: 260, overflowY: "auto", mb: 2, pr: 1, display: "flex", flexDirection: "column", gap: 2 }}>
              {messages.length === 0 && (
                <Stack alignItems="center" justifyContent="center" sx={{ height: "100%", opacity: 0.6 }}>
                  <Avatar sx={{ bgcolor: "action.hover", border: 1, borderColor: "divider", width: 48, height: 48, mb: 1 }}>
                    <FiInbox style={{ color: "var(--mui-palette-text-secondary)" }} />
                  </Avatar>
                  <Typography variant="caption" sx={{ fontWeight: "bold", textTransform: "uppercase", letterSpacing: "0.1em" }}>
                    Awaiting telemetry...
                  </Typography>
                </Stack>
              )}
                ...
                >
                  <Box
                    sx={{
                      ...
                      lineHeight: 1.5,
                      boxShadow: 1,
                      bgcolor: msg.role === "user" ? "cyan.main" : "action.hover",
                  ...
                  >
                    {[0, 150, 300].map((delay) => (
                      <Box
                        ...
                        sx={{ width: 6, height: 6, borderRadius: "50%", bgcolor: "cyan.main" }}
                      />
                    ))}
                  </Box>
                </Box>
      ...
      {loadingCharts ? (
        <Grid container spacing={3}>
          <Grid size={{ xs: 12, lg: 6 }}><Skeleton variant="rectangular" height={320} sx={{ borderRadius: 6 }} /></Grid>
          <Grid size={{ xs: 12, lg: 6 }}><Skeleton variant="rectangular" height={320} sx={{ borderRadius: 6 }} /></Grid>
        </Grid>
      ) : (
        (totalIncome > 0 || totalExpenses > 0) && (
          <Grid container spacing={3}>
            ...
            <Grid size={12}>
              <Card sx={{ border: 1, borderColor: "divider", borderRadius: 6, p: 4, position: "relative", overflow: "hidden", boxShadow: 3 }}>
                <Box sx={{ position: "absolute", top: 0, left: 0, width: 256, height: 256, bgcolor: "error.main", opacity: 0.03, filter: "blur(96px)" }} />
                <Stack direction="row" spacing={2} alignItems="center" sx={{ mb: 4, position: "relative", zIndex: 1 }}>
                  <Avatar sx={{ bgcolor: "rgba(244, 63, 94, 0.1)", border: 1, borderColor: "rgba(244, 63, 94, 0.2)", color: "error.main", borderRadius: 3, width: 40, height: 40 }}>
                    <FiTrendingDown size={16} />
                  </Avatar>
                  <Box>
                    <Typography variant="subtitle2" sx={{ fontWeight: "bold" }}>Velocity Analytics</Typography>
                    <Typography variant="caption" color="text.secondary" sx={{ fontWeight: "bold", textTransform: "uppercase", letterSpacing: "0.1em" }}>30-Day Outflow Trajectory</Typography>
                  </Box>
                </Stack>
            ...
            <Grid size={{ xs: 12, lg: 6 }}>
              <Card sx={{ border: 1, borderColor: "divider", borderRadius: 6, p: 4, position: "relative", overflow: "hidden", boxShadow: 3 }}>
                <Box sx={{ position: "absolute", top: 0, left: 0, width: 192, height: 192, bgcolor: "primary.main", opacity: 0.03, filter: "blur(80px)" }} />
                <Stack direction="row" spacing={2} alignItems="center" sx={{ mb: 4, position: "relative", zIndex: 1 }}>
                  <Avatar sx={{ bgcolor: "rgba(59, 130, 246, 0.1)", border: 1, borderColor: "rgba(59, 130, 246, 0.2)", color: "primary.main", borderRadius: 3, width: 40, height: 40 }}>
                    <FiBarChart2 size={16} />
                  </Avatar>
                  <Box>
                    <Typography variant="subtitle2" sx={{ fontWeight: "bold" }}>Cash Equilibrium</Typography>
                    <Typography variant="caption" color="text.secondary" sx={{ fontWeight: "bold", textTransform: "uppercase", letterSpacing: "0.1em" }}>Aggregate Flow Comparison</Typography>
                  </Box>
                </Stack>
                <ResponsiveContainer width="100%" height={260}>
                  ...
                  >
                    <XAxis
                      dataKey="name"
                      stroke="var(--border)"
                      tick={{ fill: "var(--text-muted)", fontSize: 10, fontWeight: 700, letterSpacing: "0.1em" }}
                      axisLine={false}
                      tickLine={false}
                    />
                    <YAxis
            ...
            {categoryData.length > 0 && (
              <Grid size={{ xs: 12, lg: 6 }}>
                <Card sx={{ border: 1, borderColor: "divider", borderRadius: 6, p: 4, position: "relative", overflow: "hidden", boxShadow: 3 }}>
                  <Box sx={{ position: "absolute", top: 0, right: 0, width: 192, height: 192, bgcolor: "cyan.main", opacity: 0.03, filter: "blur(80px)" }} />
                  <Stack direction="row" spacing={2} alignItems="center" sx={{ mb: 4, position: "relative", zIndex: 1 }}>
                    <Avatar sx={{ bgcolor: "rgba(6, 182, 212, 0.1)", border: 1, borderColor: "rgba(6, 182, 212, 0.2)", color: "cyan.main", borderRadius: 3, width: 40, height: 40 }}>
                      <FiPieChart size={16} />
                    </Avatar>
                    <Box>
                      <Typography variant="subtitle2" sx={{ fontWeight: "bold" }}>Disbursement Profile</Typography>
                      <Typography variant="caption" color="text.secondary" sx={{ fontWeight: "bold", textTransform: "uppercase", letterSpacing: "0.1em" }}>Sector Allocation</Typography>
                    </Box>
                  </Stack>
                  <ResponsiveContainer width="100%" height={260}>
                    <PieChart>
      ...
      {!loadingSecondary && upcomingRecurring.length > 0 && (
        <Card sx={{ border: 1, borderColor: "divider", borderRadius: 6, p: 4, position: "relative", overflow: "hidden", boxShadow: 3 }}>
          <Box sx={{ position: "absolute", top: 0, right: 0, width: 256, height: 256, bgcolor: "warning.main", opacity: 0.03, filter: "blur(96px)" }} />
          <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 4, position: "relative", zIndex: 1 }}>
            <Stack direction="row" spacing={2} alignItems="center">
              <Avatar sx={{ bgcolor: "rgba(245, 158, 11, 0.1)", border: 1, borderColor: "rgba(245, 158, 11, 0.2)", color: "warning.main", borderRadius: 3, width: 40, height: 40 }}>
                <FiRepeat size={16} />
              </Avatar>
              <Box>
                <Typography variant="subtitle2" sx={{ fontWeight: "bold" }}>Pending Executions</Typography>
                <Typography variant="caption" color="text.secondary" sx={{ fontWeight: "bold", textTransform: "uppercase", letterSpacing: "0.1em" }}>Upcoming Automated Events</Typography>
              </Box>
            </Stack>
            <Chip
              label={`${upcomingRecurring.length} Scheduled`}
              size="small"
              sx={{ fontWeight: "black", textTransform: "uppercase", fontSize: "10px", bgcolor: "rgba(245, 158, 11, 0.1)", color: "warning.main", border: 1, borderColor: "divider" }}
            />
          </Stack>
          <Grid container spacing={3} sx={{ position: "relative", zIndex: 1 }}>
            {upcomingRecurring.map((item) => (
              <Grid size={{ xs: 12, sm: 6, lg: 4 }} key={item._id}>
                ...
                >
                  <Stack direction="row" spacing={2} alignItems="center">
                    <Avatar sx={{ bgcolor: "background.paper", border: 1, borderColor: "divider", borderRadius: 3, width: 36, height: 36 }}>
                      <FiCalendar size={14} style={{ color: "var(--mui-palette-warning-main)" }} />
                    </Avatar>
                    <Box>
                      <Typography variant="caption" sx={{ fontWeight: "bold", display: "block", textTransform: "uppercase", maxWidth: 120 }} noWrap>
                        {item.title}
                      </Typography>
                      <Typography variant="caption" color="text.secondary" sx={{ fontWeight: "bold", textTransform: "uppercase", letterSpacing: "0.05em", mt: 0.5, display: "flex", alignItems: "center", gap: 1 }}>
                        <FiClock size={10} />
                  ...
                  <Typography variant="subtitle2" sx={{ fontWeight: "black", color: "error.main" }}>
      ...
      <Card sx={{ border: 1, borderColor: "divider", borderRadius: 6, p: 4, position: "relative", overflow: "hidden", boxShadow: 3 }}>
        <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 4, position: "relative", zIndex: 1 }}>
          <Stack direction="row" spacing={2} alignItems="center">
            ...
            <Box>
              <Typography variant="subtitle2" sx={{ fontWeight: "bold" }}>Intelligence Log</Typography>
              <Typography variant="caption" color="text.secondary" sx={{ fontWeight: "bold", textTransform: "uppercase", letterSpacing: "0.1em" }}>Historical Telemetry</Typography>
            </Box>
          </Stack>
          {allInsights.length === 0 && !loadingHistory && (
            <Button
              ...
              sx={{ fontWeight: "bold", textTransform: "none", borderRadius: 3 }}
            >
              Sync Logs
            </Button>
          )}
        ...
        {loadingHistory ? (
          ...
          <Stack alignItems="center" justifyContent="center" spacing={2} sx={{ py: 6, opacity: 0.6 }}>
            <Avatar sx={{ bgcolor: "action.hover", border: 1, borderColor: "divider", width: 48, height: 48 }}>
              <FiInbox style={{ color: "var(--mui-palette-text-secondary)" }} />
            </Avatar>
            <Box textAlign="center">
              ...
              <Typography variant="body2" color="text.secondary" sx={{ maxW: 280, mx: "auto", mt: 0.5 }}>
                Trigger AI modules to populate your historical intelligence ledger.
              </Typography>
            </Box>
          </Stack>
        ) : (
