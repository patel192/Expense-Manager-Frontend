...
const MetricCard = memo(({ title, value, icon, color, bg, border }) => (
  ...
  >
    ...
    <div className="relative">
      <div
        className={`w-9 h-9 rounded-xl flex items-center justify-center mb-3 ${bg} border ${border}`}
      >
...
const AICard = memo(
  ({ title, icon, iconColor, iconBg, borderColor, accentColor, children }) => (
    <div
      className={`rounded-2xl bg-[#0d0f14]/80 border ${borderColor} backdrop-blur-sm overflow-hidden`}
    >
      <div
...
export const UserDashboard = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        { role: "ai", text: res.data?.reply || "AI returned no response." },
      ]);
    } catch (error) {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <div
          className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl border text-sm font-medium self-start
          ${
            savingsRate >= 20
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          ...
          <div className="relative">
            ...
            <p
              className={`text-2xl font-bold tracking-tight ${netSavings >= 0 ? "text-blue-400" : "text-rose-400"}`}
            >
          ...
          {loadingRisk ? (
            ...
            >
              ...
              <div className="space-y-2 text-sm">
                ...
                <p
                  className={`font-medium ${riskColors[riskData.riskLevel]?.text}`}
                >
                  {riskData.suggestion}
                </p>
              </div>
            ...
            <div className="space-y-3">
              ...
              <AIButton
                onClick={fetchRisk}
                label="Analyze Risk"
                color="bg-rose-500/15 border border-rose-500/25 text-rose-300 hover:bg-rose-500/25"
              />
            </div>
          )}
        </AICard>
          ...
          {loadingHealth ? (
            ...
            <div className="space-y-3">
              ...
              <AIButton
                ...
                color="bg-violet-500/15 border border-violet-500/25 text-violet-300 hover:bg-violet-500/25"
              />
            </div>
          )}
        </AICard>
          ...
          {loadingInsights ? (
            ...
            <div className="space-y-3">
              ...
              <AIButton
                ...
                color="bg-cyan-500/15 border border-cyan-500/25 text-cyan-300 hover:bg-cyan-500/25"
              />
            </div>
          )}
        </AICard>
          ...
          {loadingForecast ? (
            ...
            <div className="space-y-3">
              ...
              <AIButton
                ...
                color="bg-blue-500/15 border border-blue-500/25 text-blue-300 hover:bg-blue-500/25"
              />
            </div>
          )}
        </AICard>
          ...
          {loadingSavings ? (
            ...
            <div className="space-y-3">
              ...
              <AIButton
                ...
                color="bg-emerald-500/15 border border-emerald-500/25 text-emerald-300 hover:bg-emerald-500/25"
              />
            </div>
          )}
        </AICard>
        ...
        {loadingHistory ? (
          ...
          <div className="flex flex-col items-center gap-2 py-8 text-center">
            ...
            <p className="text-xs text-gray-700">
              Use the AI tools above to generate your first insight.
            </p>
          </div>
        ) : (
          <div className="space-y-3">
