              ...
              {[
                {
                  ...
                  text: "Your spending summary is ready to view",
                  color: "text-cyan-400",
                  bg: "bg-cyan-500/10 border-cyan-500/20",
                },
                {
                  icon: <FiPieChart size={15} />,
                  text: "Budget progress updated in real-time",
                  color: "text-emerald-400",
                  bg: "bg-emerald-500/10 border-emerald-500/20",
                },
                {
                  icon: <FiShield size={15} />,
                  text: "Secure login with encrypted sessions",
                  color: "text-blue-400",
                ...
                <div key={i} className="flex items-center gap-3">
                  <div
                    className={`w-8 h-8 rounded-lg border flex items-center justify-center flex-shrink-0 ${item.bg} ${item.color}`}
                  >
                    {item.icon}
                  </div>
