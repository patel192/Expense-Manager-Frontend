          ...
          <div className="space-y-10 relative z-10">
            <div className="space-y-4">
              ...
              <p className="text-lg text-[var(--text-secondary)] leading-relaxed max-w-sm">
                Start tracking income, expenses, and budgets with the world's
                most elegant dashboard.
              </p>
            </div>
            ...
            <div className="flex gap-4">
              {[
                ...
                <div
                  key={i}
                  className="flex-1 bg-[var(--surface-primary)] border border-[var(--border)] rounded-2xl p-4 text-center shadow-sm hover:shadow-md transition-all cursor-default"
                >
